...
#define RIGHT_FORWARD(x) __HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_1,0);__HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_2,x)
#define RIGHT_REVERSE(x) __HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_2,0);__HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_1,x)
#define RIGHT_Break __HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_2,1000);__HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_1,1000)

#define LEFT_FORWARD(x) __HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_3,0);__HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_4,x)
#define LEFT_REVERSE(x) __HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_4,0);__HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_3,x)
